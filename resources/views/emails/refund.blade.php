                        ...
                        <table class="ms-content" width="640" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;width:640px;margin-top:0;margin-bottom:0;margin-right:auto;margin-left:auto;padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;background-color:#FFFFFF;border-radius:6px;box-shadow:0 3px 6px 0 rgba(0,0,0,.05);" >
                            <tr>
                                <td class="ms-content-body" style="word-break:break-word;font-family:'Inter', Helvetica, Arial, sans-serif;font-size:16px;line-height:24px;padding-top:40px;padding-bottom:40px;padding-right:50px;padding-left:50px;" >
                                    ...
                                    <h1 style="margin-top:0;color:#111111;font-size:24px;line-height:36px;font-weight:600;margin-bottom:24px;" >Richiesta di Reso e Rimborso! </h1>

                                    <p style="color:#4a5566;margin-top:20px;margin-bottom:20px;margin-right:0;margin-left:0;font-size:16px;line-height:28px;" >Gentile Cliente,<br><br>Abbiamo ricevuto la tua richiesta di rimborso per l’ordine <b>#{{$order_number}}</b>.<br>
                                    La tua richiesta dovrà essere <b>approvata dal nostro Servizio Clienti.</b><br><br>

                                    Puoi controllare lo stato del tuo reso e vedere i dettagli dell’ordine al seguente <a href="{{ asset('/order-detail/' . $order_number) }}" target="_blank">link</a><br><br>

                                    Riceverai una nostra email successiva in caso:<br>
                                    <ul>
                                        <li>vengano richieste ulteriori informazioni da parte nostra</li>

                                        <li>la tua richiesta venga <b>accettata o rifiutata</b></li>
                                    </ul>

                                    Per qualsiasi domanda o chiarimento, puoi contattarci rispondendo a questa email.<br><br>

                                    Grazie per aver scelto il nostro negozio,<br><b>Il team di Farmacia19</b></p>
                                </td>
                            </tr>
                        </table>
