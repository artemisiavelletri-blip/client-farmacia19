                                ...
                                <div class="col-lg-12">
                                    <div class="user-card">
                                        ...
                                        <div class="user-form">
                                            ...
                                            @endif
                                            <form action="/settings/create-address/shipping" method="POST">
                                                @csrf
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label>Destinatario</label>
                                                            <input type="text" name="recipient_name" class="form-control" placeholder="Destinatario" value="{{ old('recipient_name') }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label>Indirizzo</label>
                                                            <input type="text" name="address" class="form-control" placeholder="Indirizzo" value="{{ old('address') }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>CAP</label>
                                                            <input type="text" name="cap" class="form-control" placeholder="CAP" value="{{ old('cap') }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="hidden" name="city_id" class="required-private" id="residenceCityId">
